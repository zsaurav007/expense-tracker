...
export default function ProfileHistoryPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 relative">
      ...
      {/* Filter Tabs */}
      <div className="bg-white px-4 py-3 border-b border-slate-100 sticky top-[73px] z-10 overflow-x-auto whitespace-nowrap hide-scrollbar">
      ...
      <div className="p-6 pb-24 space-y-6">
        {/* Total Summary Card */}
        <div className="bg-red-50 border border-red-100 rounded-3xl p-6 text-center shadow-sm">
        ...
        {/* Transactions List */}
        <div>
          <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-4">Transaction History</h3>
          <div className="space-y-3">
            {isLoading ? (
              ...
              transactions.map((tx) => (
                <div key={tx.id} className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
