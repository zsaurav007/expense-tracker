  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <div className="px-6 py-6 space-y-6 pb-24">
        {/* Create Profile Form */}
        <form onSubmit={handleAddProfile} className="relative">
          ...
          <input
            ...
            className="block w-full h-14 pl-12 pr-24 rounded-xl border border-slate-200 bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
        ...
        <div className="space-y-3">
          <h2 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-2 mt-8">Your Active Ledgers</h2>
          
          {isLoading ? (
            <p className="text-center text-slate-400 text-sm py-8">Loading ledgers...</p>
          ) : profiles.length === 0 ? (
